...
<div className="w-[1437px] h-[1278px] relative bg-white">
  <div className="w-screen h-12 pl-[445px] pr-[136px] py-3 left-0 top-0 absolute bg-black justify-end items-center inline-flex">
  ...
  <div className="left-[135px] top-[88px] absolute justify-start items-center gap-[130px] inline-flex">
    <div className="justify-start items-start gap-40 flex">
      ...
      <div className="justify-start items-start gap-12 flex ">
        ...
        <Link href="/" className=" w-12 h-6 justify-center items-center flex">  Home </Link>
         
        </div>
        <div className="w-[66px] h-6 justify-center items-center flex">

        <Link href="/contact" className=" text-center text-black text-base font-normal leading-normal">  Contact </Link>
        
        </div>
        <div className="w-12 h-6 justify-center items-center flex">
        
          <Link href="/about" className=" text-center text-black text-base font-normal leading-normal">  About </Link>
        </div>
        <div className="w-[61px] h-6 justify-center items-center flex">
        <Link href="/signup" className=" text-center text-black text-base font-normal leading-normal">  Sign Up </Link>
  ...
  <div className="left-[135px] top-[222px] absolute justify-start items-center gap-3 inline-flex">
    ...
    <div className="opacity-50 text-black text-sm font-normal leading-[21px]">Home</div>
  ...
  <div className="left-[400px] top-[300px] absolute flex-col justify-start items-center gap-10 inline-flex">
    <div className="text-black text-[110px] font-medium leading-[115px] tracking-[3.30px]">404 Not Found</div>
    <div className="text-black text-base font-normal leading-normal">Your visited page not found. You may go home page.</div>
  </div>
  <div className="px-12 py-4  left-[700px] top-[565px] absolute bg-red-500 rounded justify-center items-center gap-2.5 inline-flex">
    <Link href="/" className="text-neutral-50 text-base font-medium leading-normal">
        Back to home page
        
        </Link>
  </div>
  <div className="w-screen h-[440px] pt-20 pb-6 left-0 top-[838px] absolute bg-black flex-col justify-end items-center gap-[60px] inline-flex">
